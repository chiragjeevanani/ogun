export const adminUi = {
  ...
  panel: 'overflow-hidden rounded-lg border border-gray-200 bg-white',
  ...
  primaryButton: 'rounded-md bg-black px-4 py-2 text-sm text-white transition hover:bg-gray-900',
  secondaryButton: 'rounded-md border border-gray-300 px-3 py-1 text-sm text-gray-700 transition hover:bg-gray-100',
  ...
  tableRow: 'border-b border-gray-200 last:border-b-0 hover:bg-gray-50',
