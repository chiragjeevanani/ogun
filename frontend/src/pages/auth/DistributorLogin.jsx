  ...
  const handleDistributorLogin = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('loginData', JSON.stringify({
        email,
        role: 'distributor',
        userName: `Distributor_${email.split('@')[0]}`,
        isLoggedIn: true,
      ...
      setTimeout(() => navigate('/distributor-dashboard'), 400);
    } catch (err) {
        ...
        <div className="bg-white rounded-xl shadow-md p-8 border border-gray-200">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-lg font-bold text-gray-900">KitchenHub Distributor</span>
            </div>
            <h1 className="text-2xl font-bold text-gray-900 mb-1">Distributor Login</h1>
            <p className="text-sm text-gray-500">Sign in to your distributor account</p>
          </div>
          ...
          {/* Form */}
          <form onSubmit={handleDistributorLogin} className="space-y-5">
            {/* Email */}
            <div>
              ...
              <input
                ...
                placeholder="distributor@kitchenhub.com"
