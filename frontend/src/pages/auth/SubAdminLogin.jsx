  ...
  const handleSubAdminLogin = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('loginData', JSON.stringify({
        email,
        role: 'subadmin',
        userName: `SubAdmin_${email.split('@')[0]}`,
        isLoggedIn: true,
      ...
      setTimeout(() => navigate('/subadmin-dashboard'), 400);
    } catch (err) {
        ...
        <div className="bg-white rounded-xl shadow-md p-8 border border-gray-200">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-lg font-bold text-gray-900">KitchenHub Sub Admin</span>
            </div>
            <h1 className="text-2xl font-bold text-gray-900 mb-1">Sub Admin Login</h1>
            <p className="text-sm text-gray-500">Sign in to your sub admin account</p>
          </div>
          ...
          {/* Form */}
          <form onSubmit={handleSubAdminLogin} className="space-y-5">
            {/* Email */}
            <div>
              ...
              <input
                ...
                placeholder="subadmin@kitchenhub.com"
